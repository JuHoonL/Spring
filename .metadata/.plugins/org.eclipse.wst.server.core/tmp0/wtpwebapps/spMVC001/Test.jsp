	...
	<script>
		...
		function open_translate(elmnt) {
			...
			if (a.style.display == "") {
				...
				elmnt.innerHTML = "_$tag_________&#xe801;_$ta";
			} else {
				a.style.display = "";
				...
				elmnt.innerHTML = "_$tag_________________________________________________________________________________________________X_$tag__";
			}
		}
		...
		function clickFBLike() {
			...
			document.getElementById("popupDIV").innerHTML = "<iframe src='/fblike.asp?r="
					+ Math.random()
					+ "' frameborder='no' style='height:200px;width:250px;'>_$tag_____$ta<button onclick='hideFBLike()' class='w3-button w3-dark-grey w3-hover-black'>Close_$tag____";
		}
		function hideFBLike() {

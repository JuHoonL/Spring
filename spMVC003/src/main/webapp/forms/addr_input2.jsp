...
<title>주소록 입력</title>
	<style>
		...
		#button-div button {
			margin: 3px;
			width: 100px;
		/*	transition-duration:2s; 커서선택시 버튼색 바꾸기 */	
		}
	...
	<section>
		<c:choose>
			...
			<fieldset>
				...
				<!-- <input type="text" id="ad_addr1" name="ad_addr1"><br /> -->
				...
				</select><br /> <!-- select를 사용하고 옵션을 넣어주면 선택박스를 만들수있다 -->
				
				<label for="ad_addr2">상세주소</label>
				<input type="text" id="ad_addr2" name="ad_addr2"/ size=30 value="${addrList.rows[0].ad_addr2}"/>
				<hr />
				<div id="button-div">
					<button>주소등록</button>

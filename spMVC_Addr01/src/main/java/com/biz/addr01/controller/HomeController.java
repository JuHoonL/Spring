package com.biz.addr01.controller;
...
import com.biz.addr01.model.AddrVO;
import com.biz.addr01.service.SelectService;
...
//		model.addAttribute("CITIES",sService.getCities2());
	...
	@ResponseBody
	@RequestMapping(value="addr", method=RequestMethod.POST, produces="text/html; charset=utf8")

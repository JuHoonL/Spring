...
<section id="form-section">
	<form enctype="multipart/form-data" action=<c:url value="e_save"/> method="POST">
		...
		<textarea id="s_content" name="s_content" cols="5">${EMAIL.s_content}</textarea><br/>
		...
		<hr />
		<label></label>
		<c:if test="${BUTTON == 'ESEND'}">
			<button type="button" id="btn-send">메일보내기</button>
		</c:if>
